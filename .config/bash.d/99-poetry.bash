...
_poetry_9cf82bc144790825_complete()
{
    ...
    if [[ ${cur} == --* ]] ; then
        ...
        case "$com" in
            ...
            (add)
                opts="${opts} --allow-prereleases --dev --dry-run --editable --extras --group --lock --optional --platform --pyth
on --source"
                ;;
...
complete -o default -F _poetry_9cf82bc144790825_complete $(which poetry)
